...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('competencias', function (Blueprint $table) {
            ...
            $table->integer('estado')->default(1); // 0 = deshabilitado / 1 = inscripcion de jueces / 2 = inscripcion de competidores / 3 = inscripcion cerrada y competencia en curso / 4 = competencia finalizada
            $table->timestamps();
        });
    }
