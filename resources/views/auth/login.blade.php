    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <div for="email" id="emailFeedback" class="text-base">&nbsp;</div>
            </div>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="flex items-center">
                    ...
                    <span class="ml-2 text-md text-gray-600">{{ __('Recordarme') }}</span>
                </label>
            </div>

            <div class="flex items-center justify-end mt-4">
                <!-- Poder cambiar la contraseña si es olvidada -->
                ...
                <!-- Poder ir al registro en la pagina -->
