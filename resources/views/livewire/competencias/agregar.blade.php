    ...
    <div class="w-3/4 m-auto py-5">
        ...
        <form wire:submit.prevent="{{$accionForm}}" enctype="multipart/form-data">
                        ...
                        <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                            ...
                            <div class="flex items-center pl-3">
                                @if ($seleccionado == true)
                                    <input id="{{$categoria->id}}" wire:model="categoria" type="checkbox" value="{{$categoria->id}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" checked>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <div class="div-botones guardar-cancelar">
