        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div class="mb-4">
                    ...
                    <input id="nameTeam" type="text" class="w-full border-gray-300 rounded-md p-2" wire:model="escuela" {{$editarEscuela}}>
                ...
                <div class="mb-4">
                    ...
                    <input id="graduacion" type="text" class="w-full border-gray-300 rounded-md p-2" wire:model="graduacion" {{$editarGraduacion}}>
