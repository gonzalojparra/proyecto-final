<div>
    ...
    <form id="inscripcion" wire:model='open' class="bg-white dark:bg-gray-900" action="{{route('verUnaCompetencia')}}" method="POST">
        @csrf
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="nuevaEscuela" id="escuela" class="form-select">
                            ...
                            <option wire:model="escuelaId">{{ $team->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="flex justify-end">
