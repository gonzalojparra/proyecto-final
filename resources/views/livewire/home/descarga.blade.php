        ...
        <div id="extralarge-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-7xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <!-- Modal header -->
                    <x-slot name='title'><div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-medium text-gray-900 dark:text-dark">
                    ...
                    <!-- Modal body -->
                    <x-slot name='content'><div class="p-6 space-y-6">
                        <embed src="{{asset('image/TP-1_ADDS.pdf')}}" width="100%" height="600" type="application/pdf" allowfullscreen='true'>
                    </div></x-slot>
                    
                    <!-- Modal footer -->
                    <x-slot name='footer'><div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
